...
class MatrixTest < Minitest::Test
  ...
  def test_initialize_5()
    assert_raises(ArgumentError)  { MyMatrix.new(1.5,"abc",nil) }
  end

  def test_initialize_6()
    assert_raises(ArgumentError)  { MyMatrix.new(1.5,"abc") }
  end

  def test_initialize_7()
    assert_raises(ArgumentError)  { MyMatrix.new(1.5) }
  end

  def test_initialize_8()
    assert_raises(ArgumentError)  { MyMatrix.new("testing with some junk") }
  end

  def test_initialize_9()
    assert_raises(ArgumentError)  { MyMatrix.new(-3,-5,5) }
  end

  def test_get_1()
    m1 = MyMatrix.new(3,4,5)
  ...
  def test_add_1
    ...
    m3 = MyMatrix.new(3,4,30)
    assert_equal(m3, m1.add(m2))
  end

  def test_add_2
    m1 = MyMatrix.new(3,4,10)
    m2 = MyMatrix.new(3,5,20)
  ...
  def test_multiply_1
    m1 = MyMatrix.new(3,3,10)
    m2 = MyMatrix.new(3,3,10)
    m3 = MyMatrix.new(3,3,300)
    assert_equal(m3,m1.multiply(m2))
  end

  def test_multiply_2
    m1 = MyMatrix.new(3,4,10)
    m2 = MyMatrix.new(4,3,10)
    m3 = MyMatrix.new(3,3,400)
    assert_equal(m3,m1.multiply(m2))
  end

  def test_multiply_3
    m1 = MyMatrix.new(4,3,10)
    m2 = MyMatrix.new(3,4,10)
    m3 = MyMatrix.new(4,4,300)
    assert_equal(m3,m1.multiply(m2))
  end
  ...
  def test_transpose_2
    m1 = MyMatrix.new(3,4,5)
    m2 = MyMatrix.new(4,3,5)
    assert_equal(m2,m1.transpose())
  end

  def test_transpose_3
    m1 = MyMatrix.new(4,4,5)
  ...
  def test_identity_1
    m1 = MyMatrix.identity(3)
    assert_equal("1 0 0\n0 1 0\n0 0 1",m1.to_s().strip())
  end

  def test_identity_2
    m1 = MyMatrix.identity(1)
    assert_equal("1",m1.to_s().strip())
  end

  def test_identity_3
    assert_raises(ArgumentError) { MyMatrix.identity(0) }
  end

  def test_identity_4
    assert_raises(ArgumentError) { MyMatrix.identity("junk") }
  end

  def test_identity_5
    assert_raises(ArgumentError) { MyMatrix.identity(false) }
  end
